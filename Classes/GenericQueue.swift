...
public class GenericQueue<T> {
    ...
    // queue
    var queue: AtomicArray<T>? = nil
    private var isFlushing = false  // flushing indicator
    private var appendDispatchQueue: DispatchQueue!  // the associated dispatch queue
    private var performDispatchQueue: DispatchQueue!  // the associated dispatch queue
