//
//  DeviceModelGetter.swift
//  GeneralRemoteiOS
//
//  Created by Oz Shabat on 15/02/2022.
...
public extension UIDevice {
    ...
    var type: ModelType {
        ...
        guard let mcode = modelCode, let map = String(validatingUTF8: mcode), let model = modelMap[map] else { return ModelType.unrecognized }
        if model == .simulator {
